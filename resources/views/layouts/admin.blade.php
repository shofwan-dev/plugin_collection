...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - {{ \App\Models\Setting::get('site_name', 'CF7 to WhatsApp') }}</title>
    ...
    <div class="d-flex">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item">
                    <a href="{{ route('admin.landing-pages.index') }}" class="nav-link {{ request()->routeIs('admin.landing-pages.*') ? 'active' : '' }}">
