...
return [
    ...
    */
    ...
    'seller_id' => env('PADDLE_SELLER_ID') ?? env('PADDLE_VENDOR_ID'),

    'client_side_token' => env('PADDLE_CLIENT_SIDE_TOKEN') ?? env('PADDLE_CLIENT_TOKEN'),

    'api_key' => env('PADDLE_API_KEY') ?? env('PADDLE_AUTH_CODE'),
    ...
    */
    ...
    'sandbox' => env('PADDLE_SANDBOX', env('PADDLE_ENVIRONMENT') === 'sandbox'),
